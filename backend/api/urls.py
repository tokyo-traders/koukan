...
from .views_folder.home_views import single_offer, items_offered, homepage, listingItem, search_item, category_list, currentUser_review, sendUserReview, send_review, userListing,categoryListing
...
urlpatterns = [
    ...
    path('homepage/category/<int:category>', categoryListing),
