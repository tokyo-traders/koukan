            ...
            >
                    ...
                    >
                        ...
                        <CardContent >
                            <Box display="flex" justify="space-between">
                                <Typography sx={{ justifyContent: "center", display: "flex" }} gutterBottom variant="body">{offer?.itemOffered}</Typography>
                            </Box>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={3}>
                    ...
                    >
                        ...
                        <CardContent >
                            <Box display="flex" justify="space-between">
                                <Typography sx={{ justifyContent: "center", display: "flex" }} gutterBottom variant="body">{offer?.desiredItem}</Typography>
                            </Box>
                        </CardContent>
                    </Card>
                </Grid>
